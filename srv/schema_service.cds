...
service aplicacion {
    ...
    entity Store_Owner as select from my.Store_Owner{
        *,
    ...
    entity ProductSubtype as select from my.ProductSubtype{
        *,
        product.name as product_name,
    ...
    entity Vista_de_Productos as select from my.Products {
        ID,
        name,
    ...
    } where brand.name = 'Arcor';

    entity Vista_Precios as select from my.Products {
        ID,
        name,
        brand.name as brand_name,
        productsubtype.producttype.name as type_name,
        ...
        precio.currency as precio_currency,
        precio.costo as costo
    } where precio.costo > 10 and precio.costo < 200;
